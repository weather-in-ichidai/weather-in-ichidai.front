  ...
  return (
    <div className="relative">
      <div className="max-w-7xl mx-auto relative">
        <div className="absolute w-full flex justify-center top-7">
          <div>
            <span className="sr-only">Weather in Ichidai</span>
            <Image src="/logo-white.png" width={35} height={35} />
          </div>
        </div>
        <div className="flex justify-end items-center py-6 md:space-x-10 px-4 sm:px-6">
          <button
            type="button"
